      ...
      <div className="py-12 md:py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center pb-12">
            <h2 className="font-inter-tight text-3xl md:text-4xl font-bold text-zinc-900 mb-4">SimpleDoc Features</h2>
            <p className="text-lg text-zinc-500">*Insert SimpleDoc blurb*</p>
          </div>
          <div>
            {/* Tabs buttons */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
              ...
              >
                <div className="flex items-center justify-between mb-1">
                  <div className="font-inter-tight font-semibold text-zinc-900">Personalized Education</div>
                ...
                <div className="text-sm text-zinc-500">Insert Subtitle</div>
              </button>
              <button
              ...
              >
                <div className="flex items-center justify-between mb-1">
                  <div className="font-inter-tight font-semibold text-zinc-900">AI-Powered Guidance and Feedback</div>
              ...
              >
                <div className="flex items-center justify-between mb-1">
                  <div className="font-inter-tight font-semibold text-zinc-900">Structured Curriculums Developed with Partners</div>
              ...
              >
                <div className="flex items-center justify-between mb-1">
                  <div className="font-inter-tight font-semibold text-zinc-900">Patient and Provider Facing Progress Tracking</div>
