...
import FeatureImage01 from '@/public/images/Sailboat.jpg'
import FeatureImage02 from '@/public/images/Sailboat.jpg'
      ...
      <div className="py-12 md:py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="relative max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="font-inter-tight text-3xl md:text-4xl font-bold text-zinc-200 mb-4">What We Do</h2>
            <p className="text-lg text-zinc-200">*Insert What We Do Subtitle*</p>
          </div>
            ...
            <article className="sm:col-span-2 flex flex-col border border-transparent [background:linear-gradient(theme(colors.white),theme(colors.zinc.50))_padding-box,linear-gradient(120deg,theme(colors.zinc.300),theme(colors.zinc.100),theme(colors.zinc.300))_border-box] rounded-lg">
              <div className="grow flex flex-col p-5 pt-6">
                <div className="flex items-center space-x-3 mb-1">
                  ...
                  <h3 className="font-inter-tight font-semibold text-zinc-900">Health Literacy</h3>
                </div>
                <p className="grow max-w-md text-md text-zinc-500">Health literacy is a major problem in the US because: </p>
                <ul className="text-zinc-600 dark:text-zinc-400 text-sm space-y-3 grow">
                      <li className="flex items-center">
                        ...
                        <Tooltip id="01" content="Lorem Ipsum is simply dummy text of the printing.">
                          Over half of adults in the US read below a 6th grade reading level
                        </Tooltip>
                      </li>
                      <li className="flex items-center">
                        <svg className="w-3 h-3 fill-emerald-500 mr-3 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <Tooltip id="02" content="Lorem Ipsum is simply dummy text of the printing.">
                          An average doctor’s appointment lasts less than 20 minutes
                        </Tooltip>
                      </li>
                      <li className="flex items-center">
                        <svg className="w-3 h-3 fill-emerald-500 mr-3 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        ...
                        The healthcare system is overwhelmingly complex
                        </Tooltip>
                      </li>
                      <li className="flex items-center">
                        <svg className="w-3 h-3 fill-emerald-500 mr-3 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <Tooltip id="05" content="Lorem Ipsum is simply dummy text of the printing.">
                          Patients often turn to the internet and other unverified resources for health information.
                        </Tooltip>
                      </li>
                    </ul>
              </div>
            ...
            <article className="flex flex-col border border-transparent [background:linear-gradient(theme(colors.white),theme(colors.zinc.50))_padding-box,linear-gradient(120deg,theme(colors.zinc.300),theme(colors.zinc.100),theme(colors.zinc.300))_border-box] rounded-lg">
              <div className="grow flex flex-col p-5 pt-6">
                <div className="flex items-center space-x-3 mb-1">
                  ...
                  <h3 className="font-inter-tight font-semibold text-zinc-900">Patient Outcomes</h3>
                </div>
                <p className="grow max-w-md text-sm text-zinc-500">*Insert Statistics Here*</p>
              </div>
              <figure>
            ...
            {/* <article className="flex flex-col border border-transparent [background:linear-gradient(theme(colors.white),theme(colors.zinc.50))_padding-box,linear-gradient(120deg,theme(colors.zinc.300),theme(colors.zinc.100),theme(colors.zinc.300))_border-box] rounded-lg">
              <div className="grow flex flex-col p-5 pt-6">
                <div className="flex items-center space-x-3 mb-1">
                  ...
                  <h3 className="font-inter-tight font-semibold text-zinc-900">Personalized Health Curriculums</h3>
                </div>
                <p className="grow max-w-md text-sm text-zinc-500">*Blurb about health literacy level assessment & personalized learning*</p>
              </div>
              <figure>
            ...
            <article className="flex flex-col border border-transparent [background:linear-gradient(theme(colors.white),theme(colors.zinc.50))_padding-box,linear-gradient(120deg,theme(colors.zinc.300),theme(colors.zinc.100),theme(colors.zinc.300))_border-box] rounded-lg">
              <div className="grow flex flex-col p-5 pt-6">
                <div className="flex items-center space-x-3 mb-1">
                  ...
                  <h3 className="font-inter-tight font-semibold text-zinc-900">Accessible & Easy-to-Use Interface</h3>
                </div>
                <p className="grow max-w-md text-sm text-zinc-500">*Blurb about design principles*</p>
              </div>
              <figure>
            ...
            <article className="flex flex-col border border-transparent [background:linear-gradient(theme(colors.white),theme(colors.zinc.50))_padding-box,linear-gradient(120deg,theme(colors.zinc.300),theme(colors.zinc.100),theme(colors.zinc.300))_border-box] rounded-lg">
              <div className="grow flex flex-col p-5 pt-6">
                <div className="flex items-center space-x-3 mb-1">
                  ...
                  <h3 className="font-inter-tight font-semibold text-zinc-900">AI-Powered Real-Time Feedback</h3>
                </div>
                <p className="grow max-w-md text-sm text-zinc-500">Our platform enables patients to access verified health information in real time and at a level they understand.</p>
              </div>
              <figure>
