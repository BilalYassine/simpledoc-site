...
import CarouselIllustration from '@/public/images/Sailboat.jpg'
          ...
          <div className="lg:flex space-y-12 lg:space-y-0 lg:space-x-12 xl:space-x-24">
            ...
            <div className="lg:max-w-none lg:min-w-[524px]">
              <div className="mb-8">
                ...
                <h3 className="font-inter-tight text-3xl font-bold text-zinc-200 mb-4">SimpleDoc Features</h3>
                <p className="text-lg text-zinc-200">*Insert Features blurb*</p>
              </div>
              {/* Tabs buttons */}
              <div className="mb-8 md:mb-0 space-y-2">
                ...
                >
                  ...
                  <div>
                    <div className="font-inter-tight text-lg font-semibold text-zinc-200 mb-1">Personalized Education</div>
                    <div className="text-zinc-200">*Description of personalized curriculums*</div>
                    <div className="text-zinc-200">*How healthy literacy levels are assessed*</div>
                    <div className="text-zinc-200">*How progress is monitored and reported*</div>
                  </div>
                </button>
                <button
                ...
                >
                  ...
                  <div>
                    <div className="font-inter-tight text-lg font-semibold text-zinc-200 mb-1">AI-Powered Guidance and Feedback</div>
                    <div className="text-zinc-200">*Description of AI Features*</div>
                    <div className="text-zinc-200">*How AI enhances the learning experience*</div>
                  </div>
                </button>
                <button
                ...
                >
                  ...
                  <div>
                    <div className="font-inter-tight text-lg font-semibold text-zinc-200 mb-1">Structured, Condition Specific Curriculums Developed with Partners</div>
                    <div className="text-zinc-200">*Examples of condition-specific curriculums*</div>
                    <div className="text-zinc-200">*Benefits of structured learning*</div>
                    <div className="text-zinc-200">*Benefits for patients and providers*</div>
                  </div>
                </button>
              </div>
            </div>
